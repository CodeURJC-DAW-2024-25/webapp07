...
import {Booking} from "../dtos/booking.model"; // Asegúrate de definir el modelo en el archivo 'restaurant.model.ts'
...
export class RestaurantService {
  ...
  searchByLocation(query: string): Observable<Restaurant[]> {
    return this.http.get<Restaurant[]>(`${this.apiUrl}?query=${query}`);
  }
