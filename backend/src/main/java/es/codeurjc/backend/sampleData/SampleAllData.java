   ...
   //private UserRepository userRepository;
    ...
    public void init() throws SQLException {
        ...
        Dish croquetasJamon = new Dish(
                "Croquetas de jamón","Croquetas caseras de nuestra cocinera. Preparadas con el ingrediente secreto de la casa", 8,
                Arrays.asList("Leche", "harina", "pan rallado", "jamón", "huevo"),
                true,"https://th.bing.com/th/id/OIP.hVsuwAU-55Z_Qk649qroVAHaE4?rs=1&pid=ImgDetMain"
        );
        ...
        Dish tortillaEspanola = new Dish(
                "Tortilla Española","Tortilla de patatas tradicional con cebolla caramelizada",6,
        ...
        Dish paellaMariscos = new Dish(
                "Paella de Mariscos","Paella tradicional con una mezcla de mariscos frescos",15,
                Arrays.asList("Arroz", "mariscos", "caldo de pescado", "azafrán", "pimientos"),
                false,"https://th.bing.com/th/id/OIP.hVsuwAU-55Z_Qk649qroVAHaE4?rs=1&pid=ImgDetMain"
        );
        ...
        Dish gazpacho = new Dish(
                "Gazpacho","Sopa fría de tomate y vegetales frescos",5,
        ...
        Dish pulpoGallega = new Dish(
                "Pulpo a la Gallega","Pulpo cocido con pimentón y aceite de oliva",12,
        ...
        Dish ensaladaMixta = new Dish(
                "Ensalada Mixta","Ensalada fresca con una variedad de vegetales",7,
                Arrays.asList("Lechuga", "tomate", "cebolla", "aceitunas", "atún", "huevo"),
                true,"https://th.bing.com/th/id/OIP.5.jpg"
        );
        ...
        Dish calamaresFritos = new Dish(
                "Calamares Fritos","Calamares rebozados y fritos, servidos con limón",10,
                Arrays.asList("Calamares", "harina", "aceite de oliva", "limón", "sal"),
                false,"https://pixabay.com/es/images/search/calamares%20fritos/"
        );
        ...
        Dish albondigas = new Dish(
                "Albóndigas","Albóndigas de carne en salsa de tomate",9,
                Arrays.asList("Carne picada", "pan rallado", "huevo", "tomate", "cebolla", "ajo"),
                false,"https://unsplash.com/es/s/fotos/albondigas"
        );
        ...
        Dish pimientosPadron = new Dish(
                "Pimientos de Padrón","Pimientos fritos con sal gruesa",5,
                Arrays.asList("Pimientos de Padrón", "aceite de oliva", "sal"),
                true,"https://www.shutterstock.com/search/pimientos-de-padr%C3%B3n"
        );
        ...
        Dish chorizoSidra = new Dish(
                "Chorizo a la Sidra","Chorizo cocido en sidra asturiana",8,
                Arrays.asList("Chorizo", "sidra", "laurel"),
                false,"https://www.shutterstock.com/search/chorizo-la-sidra"
        );
        ...
        Dish patatasBravas = new Dish(
                "Patatas Bravas","Patatas fritas con salsa brava picante",6,
                Arrays.asList("Patatas", "tomate", "pimentón", "ajo", "aceite de oliva"),
                true,"https://www.shutterstock.com/search/patatas-bravas"
        );
        ...
        Dish fabadaAsturiana = new Dish(
                "Fabada Asturiana","Guiso de fabes con chorizo y morcilla",14,
                Arrays.asList("Fabes", "chorizo", "morcilla", "panceta", "laurel"),
                false,"https://www.gettyimages.com/photos/gazpacho"
        );
        ...
        Dish bacalaoVizcaina = new Dish(
                "Bacalao a la Vizcaína","Bacalao en salsa de pimientos y tomate",13,
