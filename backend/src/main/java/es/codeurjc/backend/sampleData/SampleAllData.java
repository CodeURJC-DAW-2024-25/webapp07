...
public class SampleAllData {
   ...
   //private UserRepository userRepository;
    ...
    public void init() throws SQLException {
        ...
        Dish tortillaEspanola = new Dish("Tortilla Española", "Tortilla de patatas tradicional con cebolla caramelizada", 6, "Patatas, huevos, cebolla, aceite de oliva, sal", true, "https://th.bing.com/th/id/OIP.hVsuwAU-55Z_Qk649qroVAHaE4?rs=1&pid=ImgDetMain");
        ...
        Dish paellaMariscos = new Dish("Paella de Mariscos", "Paella tradicional con una mezcla de mariscos frescos", 15, "Arroz, mariscos, caldo de pescado, azafrán, pimientos", false, "https://th.bing.com/th/id/OIP.hVsuwAU-55Z_Qk649qroVAHaE4?rs=1&pid=ImgDetMain");
        ...
        Dish gazpacho = new Dish("Gazpacho", "Sopa fría de tomate y vegetales frescos", 5, "Tomates, pepino, pimiento, ajo, aceite de oliva, vinagre", true, "https://th.bing.com/th/id/OIP.hVsuwAU-55Z_Qk649qroVAHaE4?rs=1&pid=ImgDetMain");
        gazpacho.setDishImagefile(gazpacho.URLtoBlob(gazpacho.getDishImagePath()));
        dishRepository.save(gazpacho);

        Dish pulpoGallega = new Dish("Pulpo a la Gallega", "Pulpo cocido con pimentón y aceite de oliva", 12, "Pulpo, patatas, pimentón, aceite de oliva, sal", false, "https://th.bing.com/th/id/OIP.hVsuwAU-55Z_Qk649qroVAHaE4?rs=1&pid=ImgDetMain");
        ...
        Dish calamaresFritos = new Dish("Calamares Fritos", "Calamares rebozados y fritos, servidos con limón", 10, "Calamares, harina, aceite de oliva, limón, sal", false, "https://pixabay.com/es/images/search/calamares%20fritos/");
        ...
        Dish albondigas = new Dish("Albóndigas", "Albóndigas de carne en salsa de tomate", 9, "Carne picada, pan rallado, huevo, tomate, cebolla, ajo", false, "https://unsplash.com/es/s/fotos/albondigas");
        albondigas.setDishImagefile(albondigas.URLtoBlob(albondigas.getDishImagePath()));
        dishRepository.save(albondigas);

        Dish pimientosPadron = new Dish("Pimientos de Padrón", "Pimientos fritos con sal gruesa", 5, "Pimientos de Padrón, aceite de oliva, sal", true, "https://www.shutterstock.com/search/pimientos-de-padr%C3%B3n");
        ...
        Dish chorizoSidra = new Dish("Chorizo a la Sidra", "Chorizo cocido en sidra asturiana", 8, "Chorizo, sidra, laurel", false, "https://www.shutterstock.com/search/chorizo-la-sidra");
        chorizoSidra.setDishImagefile(chorizoSidra.URLtoBlob(chorizoSidra.getDishImagePath()));
        dishRepository.save(chorizoSidra);

        Dish patatasBravas = new Dish("Patatas Bravas", "Patatas fritas con salsa brava picante", 6, "Patatas, tomate, pimentón, ajo, aceite de oliva", true, "https://www.shutterstock.com/search/patatas-bravas");
        patatasBravas.setDishImagefile(patatasBravas.URLtoBlob(patatasBravas.getDishImagePath()));
        dishRepository.save(patatasBravas);

        Dish fabadaAsturiana = new Dish("Fabada Asturiana", "Guiso de fabes con chorizo y morcilla", 14, "Fabes, chorizo, morcilla, panceta, laurel", false, "https://www.gettyimages.com/photos/gazpacho");
        ...
        Dish bacalaoVizcaina = new Dish("Bacalao a la Vizcaína", "Bacalao en salsa de pimientos y tomate", 13, "Bacalao, pimientos, tomate, cebolla, ajo", false, "https://www.gettyimages.com/photos/gazpacho");
        ...
        Dish empanadaGallega = new Dish("Empanada Gallega", "Empanada rellena de atún y pimientos", 7, "Harina, atún, pimientos, cebolla, tomate", true, "https://www.gettyimages.com/photos/gazpacho");
        ...
        Dish flanCasero = new Dish("Flan Casero", "Flan de huevo con caramelo", 5, "Huevos, leche, azúcar, vainilla", true, "https://www.gettyimages.com/photos/gazpacho");
